...
<body class="sb-nav-fixed">
                ...
                <div class="container">
                    ...
                    <div class="row  mb-3 mt-3">
                        ...
                        <div class="d-flex justify-content-end mb-2 col-8">
                            <select name="kategori" id="kategori" class="form-control btn btn-secondary w-25 ml-auto" onchange="kategori()">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="small mb-1" for="inputKategoriProduk">Kategori Produk</label>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $koneksi->query("INSERT INTO produk (id_kategori, nama_produk, harga_produk, foto_produk, deskripsi_produk ,hp_produk ,alamat_produk) VALUES('$_POST[KategoriProduk]','$_POST[namaproduk]', '$_POST[hargaproduk]', '$nama', '$_POST[deskripsiproduk]', '$_POST[nohp]', '$_POST[alamatproduk]')");
